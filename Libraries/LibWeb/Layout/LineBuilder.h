...
public:
    ...
    void break_line(ForcedBreak, Optional<FragmentationContext const&> fragmentation_context, Optional<CSSPixels> next_item_width = {});
    ...
    bool break_if_needed(CSSPixels next_item_width, Optional<FragmentationContext const&> fragmentation_context)
    {
    ...
    void update_last_line(Optional<FragmentationContext const&>);
