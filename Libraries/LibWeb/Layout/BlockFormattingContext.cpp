...
void BlockFormattingContext::run(AvailableSpace const& available_space, Optional<FragmentationContext&> fragmentation_context)
{
    ...
    if (column_count.has_value() && !fragmentation_context.has_value()) {
        ...
        CSSPixels preferred_column_height;
        ...
        case CSS::ColumnFill::BalanceAll:
            ...
            // balanced.
            preferred_column_height = measuring_context.automatic_content_height() / column_count.value();
            break;
        case CSS::ColumnFill::Auto:
            ...
            preferred_column_height = is_height_limited ? available_space.height.to_px_or_zero() : measuring_context.automatic_content_height();
            break;
        }
